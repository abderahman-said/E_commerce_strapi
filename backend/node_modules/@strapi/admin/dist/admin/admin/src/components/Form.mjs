...
import { Dialog, Button, useCallbackRef, useComposedRefs, Box } from '@strapi/design-system';
 ...
 */ const Form = /*#__PURE__*/ React.forwardRef(({ disabled = false, method, onSubmit, initialErrors, ...props }, ref)=>{
    ...
    const modified = React.useMemo(()=>!isEqual(initialValues.current, state.values), // eslint-disable-next-line react-hooks/exhaustive-deps
    [
        state.values,
