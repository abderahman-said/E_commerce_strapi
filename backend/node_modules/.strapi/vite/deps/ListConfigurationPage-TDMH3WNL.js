...
`;
var DragButton = ct(ActionButton)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
  border-right: 1px solid ${({ theme }) => theme.colors.neutral150};
  cursor: all-scroll;
`;
var FieldContainer = ct(T)`
  max-height: 3.2rem;
  cursor: pointer;
`;
var FieldWrapper = ct(R)`
  &:last-child {
...
//# sourceMappingURL=ListConfigurationPage-TDMH3WNL.js.map
