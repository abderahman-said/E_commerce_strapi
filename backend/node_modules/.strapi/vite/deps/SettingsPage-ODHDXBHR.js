...
// node_modules/@strapi/i18n/node_modules/@strapi/icons/dist/symbols-index.mjs
...
var I2 = (0, import_react.forwardRef)(r);
...
var t1 = (0, import_react.forwardRef)(x);
...
var n12 = (0, import_react.forwardRef)(D);
var A = (t, e) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", width: 16, height: 16, ref: e, ...t, children: [
...
var CreateLocale = ({ disabled, variant = "default" }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(n1.Root, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(n1.Trigger, {
      ...
      (0, import_jsx_runtime2.jsx)(CreateModal, {
    ...
    children: (0, import_jsx_runtime2.jsxs)(Form, {
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(n1.Body, {
          children: (0, import_jsx_runtime2.jsxs)(S1.Root, {
            variant: "simple",
            defaultValue: "basic",
            children: [
              (0, import_jsx_runtime2.jsxs)(T, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime2.jsxs)(S1.List, {
              ...
              (0, import_jsx_runtime2.jsxs)(R, {
                ...
                children: [
                  (0, import_jsx_runtime2.jsx)(S1.Content, {
                    value: "basic",
                    children: (0, import_jsx_runtime2.jsx)(BaseForm, {})
                  }),
                  (0, import_jsx_runtime2.jsx)(S1.Content, {
                    value: "advanced",
                    children: (0, import_jsx_runtime2.jsx)(AdvancedForm, {})
                  })
                ]
              })
            ]
        ...
        (0, import_jsx_runtime2.jsxs)(n1.Footer, {
          children: [
            ...
            (0, import_jsx_runtime2.jsx)(SubmitButton, {})
          ]
        })
      ]
    })
...
var BaseForm = ({ mode = "create" }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Um.Root, {
    gap: 4,
    children: translatedForm.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Um.Item, {
      xs: 12,
      m: size,
      direction: "column",
      alignItems: "stretch",
      children: (0, import_jsx_runtime2.jsx)(FormRenderer, {
        ...field
      })
    }, field.name))
  });
...
var AdvancedForm = ({ isDefaultLocale }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Um.Root, {
    gap: 4,
    children: form.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Um.Item, {
      xs: 12,
      m: size,
      direction: "column",
      alignItems: "stretch",
...
var FormRenderer = (field) => {
  switch (field.type) {
    case "enumeration":
      return (0, import_jsx_runtime2.jsx)(EnumerationInput, {
        ...field
      });
    default:
  ...
  return (0, import_jsx_runtime2.jsxs)(Hm.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(au, {
        ...
        children: options.map((option) => (0, import_jsx_runtime2.jsx)(gu, {
          value: option.value,
...
var EditModal = ({ id, code, isDefault, name, open, onOpenChange }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(n1.Root, {
    open,
    onOpenChange,
    children: (0, import_jsx_runtime4.jsx)(n1.Content, {
      children: (0, import_jsx_runtime4.jsxs)(Form, {
        method: "PUT",
        onSubmit: handleSubmit,
        initialValues: {
          code,
        ...
        validationSchema: LOCALE_SCHEMA,
        children: [
          (0, import_jsx_runtime4.jsx)(n1.Header, {
            children: (0, import_jsx_runtime4.jsx)(n1.Title, {
              children: formatMessage({
                id: getTranslation("Settings.list.actions.edit"),
          ...
          (0, import_jsx_runtime4.jsx)(n1.Body, {
            children: (0, import_jsx_runtime4.jsxs)(S1.Root, {
              variant: "simple",
              defaultValue: "basic",
              children: [
                (0, import_jsx_runtime4.jsxs)(T, {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime4.jsxs)(S1.List, {
                      "aria-labelledby": titleId,
                      children: [
                        (0, import_jsx_runtime4.jsx)(S1.Trigger, {
                          value: "basic",
                          children: formatMessage({
                            id: getTranslation("Settings.locales.modal.base"),
                            defaultMessage: "Basic settings"
                ...
                (0, import_jsx_runtime4.jsxs)(R, {
                  ...
                  paddingBottom: 7,
                  children: [
                    (0, import_jsx_runtime4.jsx)(S1.Content, {
                      value: "basic",
                      children: (0, import_jsx_runtime4.jsx)(BaseForm, {
                        mode: "edit"
                      })
                    }),
                    (0, import_jsx_runtime4.jsx)(S1.Content, {
                      value: "advanced",
                      children: (0, import_jsx_runtime4.jsx)(AdvancedForm, {
          ...
          (0, import_jsx_runtime4.jsxs)(n1.Footer, {
            children: [
              (0, import_jsx_runtime4.jsx)(n1.Close, {
              ...
              (0, import_jsx_runtime4.jsx)(SubmitButton, {})
            ]
          })
        ]
      })
...
var LocaleTable = ({ locales = [], canDelete, canUpdate }) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(C1, {
    colCount: 4,
    rowCount: locales.length + 1,
    children: [
      (0, import_jsx_runtime5.jsx)($1, {
        children: (0, import_jsx_runtime5.jsxs)(A1, {
          children: [
            (0, import_jsx_runtime5.jsx)(T1, {
            ...
            (0, import_jsx_runtime5.jsx)(T1, {
              children: (0, import_jsx_runtime5.jsx)(lt, {
                children: "Actions"
              })
            })
          ]
      ...
      (0, import_jsx_runtime5.jsx)(k1, {
        children: locales.map((locale) => (0, import_jsx_runtime5.jsxs)(React4.Fragment, {
          children: [
            (0, import_jsx_runtime5.jsxs)(A1, {
              onClick: handleClick(locale.id),
              style: {
                cursor: canUpdate ? "pointer" : "default"
              },
              children: [
                (0, import_jsx_runtime5.jsx)(R1, {
                  children: (0, import_jsx_runtime5.jsx)(I, {
                ...
                (0, import_jsx_runtime5.jsx)(R1, {
                  children: (0, import_jsx_runtime5.jsxs)(T, {
                    ...
                    children: [
                      canUpdate && (0, import_jsx_runtime5.jsx)(EditLocale, {
                        ...locale
                      }),
                      canDelete && !locale.isDefault && (0, import_jsx_runtime5.jsx)(DeleteLocale, {
                        ...locale
                      })
                    ]
                  })
            ...
            (0, import_jsx_runtime5.jsx)(EditModal, {
              ...locale,
...
var SettingsErrrorTooltip = ({ children, error }) => {
  const { _unstableFormatAPIError: formatAPIError } = useAPIErrorHandler();
  if (error) {
    return (0, import_jsx_runtime6.jsx)(Ar, {
...
var SettingsPage = () => {
  ...
  if (error || !Array.isArray(locales)) {
    return (0, import_jsx_runtime6.jsx)(Page.Error, {});
  }
  return (0, import_jsx_runtime6.jsxs)(Page.Main, {
    tabIndex: -1,
    children: [
      (0, import_jsx_runtime6.jsx)(Layouts.Header, {
        primaryAction: (0, import_jsx_runtime6.jsx)(CreateLocale, {
          disabled: !canCreate
        }),
        title: formatMessage({
      ...
      (0, import_jsx_runtime6.jsxs)(Layouts.Content, {
        children: [
          isAIAvailable && (0, import_jsx_runtime6.jsxs)(T, {
            background: "neutral0",
            padding: 6,
            marginBottom: 6,
            shadow: "filterShadow",
            ...
            children: [
                  ...
                  (0, import_jsx_runtime6.jsxs)(T, {
                    ...
                    children: [
                      (0, import_jsx_runtime6.jsx)(R, {
                        ...
                        children: (0, import_jsx_runtime6.jsx)(Sn, {})
                      }),
              ...
              (0, import_jsx_runtime6.jsx)(Hm.Root, {
                name: "aiLocalizations",
                minWidth: "200px",
                children: (0, import_jsx_runtime6.jsx)(SettingsErrrorTooltip, {
                  error: settingsError,
                  children: (0, import_jsx_runtime6.jsx)(E1, {
          ...
          locales.length > 0 ? (0, import_jsx_runtime6.jsx)(LocaleTable, {
            locales,
            canDelete,
            canUpdate
          }) : (0, import_jsx_runtime6.jsx)(Jm, {
            icon: (0, import_jsx_runtime6.jsx)(K, {
              width: void 0,
              height: void 0
            }),
            ...
            action: (0, import_jsx_runtime6.jsx)(CreateLocale, {
              disabled: !canCreate,
              variant: "secondary"
            })
          })
...
var ProtectedSettingsPage = () => {
  return (0, import_jsx_runtime6.jsx)(Page.Protect, {
    ...
    children: (0, import_jsx_runtime6.jsx)(SettingsPage, {})
  });
};
export {
...
//# sourceMappingURL=SettingsPage-ODHDXBHR.js.map
