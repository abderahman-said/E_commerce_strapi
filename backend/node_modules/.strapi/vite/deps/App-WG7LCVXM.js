import {
  ...
  useSelectionState,
  useUpload
} from "./chunk-4P4SVQ4H.js";
import {
  useConfig
} from "./chunk-WM7NEAMC.js";
import {
  localStorageKeys,
  useSettings,
...
var CardActionsContainer = ct(dd)`
  opacity: 0;
  z-index: 1;
...
var Extension = ct.span`
  text-transform: uppercase;
`;
var VideoPreviewWrapper = ct(R)`
  position: relative;
  height: 100%;
  overflow: hidden;
...
`;
var VideoTimerOverlay = ct(Lm)`
  position: absolute;
  bottom: 0.5rem;
  right: 0.5rem;
`;
var AudioPreviewWrapper = ct(R)`
  height: 100%;
  overflow: hidden;
  display: flex;
  align-items: center;
...
// node_modules/@strapi/upload/dist/admin/pages/App/MediaLibrary.mjs
var BoxWithHeight = ct(R)`
  height: 3.2rem;
  display: flex;
  align-items: center;
`;
var TypographyMaxWidth = ct(I)`
  max-width: 100%;
`;
var ActionContainer = ct(R)`
  svg {
    path {
...
// node_modules/@strapi/upload/dist/admin/pages/App/App.mjs
var ConfigureTheView = React6.lazy(async () => import("./ConfigureTheView-DKTWHU3R.js").then((mod) => ({
...
//# sourceMappingURL=App-WG7LCVXM.js.map
