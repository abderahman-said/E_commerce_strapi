...
var ListView = () => {
  ...
  if (!type) {
    const allowedEndpoints = Object.values(contentTypes).filter((ct2) => ct2.visible === true && !ct2.plugin).map((ct2) => ct2.uid).sort();
...
//# sourceMappingURL=ListView-UXKXGY44.js.map
